...
init 時に `.gitignore` へも自動追記。うっかり git に上げる心配はありません。
...
| **git 安心** | init 時に .gitignore へ自動追記 |
...
*ライセンス: MIT License / v1.0.0 (2026-06-21) / pi-mem の仕様を参考にしていますがコードの依存は一切ありません**ライセンス: MIT License / v1.0.0 (2026-06-21) / pi-mem の仕様を参考にしていますがコードの依存は一切ありません。単独で動きます。*
